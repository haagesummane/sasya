!(function(t) {
    ...
    var s = i(0),
      ...
      r = {
        ...
        _init: function() {
          ...
          for (var a in i)
            i.hasOwnProperty(a) &&
              t.queries.push({ name: a, value: 'only screen and (min-width: ' + i[a] + ')' });
        ...
        trapFocus: function(t) {
          ...
          t.on('keydown.zf.trapfocus', function(t) {
            t.target === o[0] && 'TAB' === s(t)
              ...
              : t.target === i[0] && 'SHIFT_TAB' === s(t) && (t.preventDefault(), o.focus());
          });
        },
              ...
              case 'attributes':
                'scroll' === e.attr('data-events') &&
                  ...
                  'style' === t[0].attributeName &&
                    ...
                    e
                      .closest('[data-mutate]')
                      .triggerHandler('mutateme.zf.trigger', [e.closest('[data-mutate]')]));
                break;
              case 'childList':
                e.closest('[data-mutate]').attr('data-events', 'mutate'),
                  e
  ...
  function(t, e, i) {
    ...
    var a = i(0),
      ...
      d = (function(t) {
        function e() {
          return (
            n(this, e), s(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments))
          );
        }
        return (
          o(e, t),
                ...
                (this.firstTimeInit = !0),
                  ...
                  (this._checkDeepLink = function() {
                    ...
                    if (e.length) {
                      ...
                      if (i.length && n) {
                        if (
                          (i.parent('[data-accordion-item]').hasClass('is-active') ||
                            (t.down(n, t.firstTimeInit), (t.firstTimeInit = !1)),
                ...
                this.$element
                  ...
                  this.$menuLinks.each(function() {
                    ...
                    t.options.submenuToggle
                      ...
                      : n.attr({ 'aria-controls': o, 'aria-expanded': a, id: e }),
            ...
            },
            {
              ...
              value: function(t) {
                ...
                this.options.multiOpen ||
                  this.up(
                    this.$element.find('.is-active').not(t.parentsUntil(this.$element).add(t))
                  ),
          ...
          f(e, [
            ...
            },
            {
              ...
              value: function() {
                u.a.Feather(this.$element, 'drilldown'),
                  ...
                  this.$element.attr(
                    'data-mutate',
                    this.$element.attr('data-drilldown') || i.i(c.a)(6, 'drilldown')
                  ),
                  this._prepareMenu(),
            ...
            },
            {
              ...
              value: function() {
                var t = this,
                  e =
                    '' != t.options.scrollTopElement ? r()(t.options.scrollTopElement) : t.$element,
                      ...
                      l.a.handleKey(e, 'Drilldown', {
                        next: function() {
                          if (o.is(t.$submenuAnchors))
                            return (
                              t._show(o.parent('li')),
                              o.parent('li').one(i.i(c.b)(o), function() {
                                o.parent('li')
                                  .find('ul li a')
                                  .filter(t.$menuItems)
                                  .first()
            ...
            },
            {
              ...
              value: function(t) {
                this.options.autoHeight &&
                  this.$wrapper.css({ height: t.children('[data-submenu]').data('calcHeight') }),
            ...
            },
            {
              ...
              value: function() {
                return (
                  ...
                  (i.i(h.c)() && !this.$element.hasClass('align-left'))
                );
              },
            },
            {
              ...
              value: function() {
                ...
                (this.options.clickOpen || e) &&
                  this.$menuItems.on('click.zf.dropdownmenu touchstart.zf.dropdownmenu', n),
                  ...
                  this.$menuItems.on('keydown.zf.dropdownmenu', function(e) {
                    ...
                    var u = function() {
                      ...
                      h = function() {
                        ...
                        i.length &&
                          (t._show(i), s.find('li > a:first').focus(), e.preventDefault());
                      },
                      d = function() {
                    ...
                    o
                      ? t._isVertical()
                        ? t._isRtl()
                          ? r.a.extend(f, { down: u, up: c, next: d, previous: h })
                          : r.a.extend(f, { down: u, up: c, next: h, previous: d })
                        : t._isRtl()
                          ? r.a.extend(f, { next: c, previous: u, down: h, up: d })
                          : r.a.extend(f, { next: u, previous: c, down: h, up: d })
                      : t._isRtl()
              ...
              value: function() {
                ...
                t.off('mouseup.zf.dropdownmenu touchend.zf.dropdownmenu').on(
                  ...
                  function(i) {
                    ...
                    n.length ||
                      (e._hide(), t.off('mouseup.zf.dropdownmenu touchend.zf.dropdownmenu'));
                  }
                );
              },
            },
            ...
            [
              {
                ...
                value: function(t) {
                  var i =
                      arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e.defaults,
                    n = arguments[2];
                      ...
                      if (r()(this).is(s))
                        return void (t.options.wrapOnKeys
                          ? ((i = 0 === e ? o.last() : o.eq(e - 1)),
                            (n = e === o.length - 1 ? o.first() : o.eq(e + 1)))
              ...
              value: function(t, e) {
                if (t.hasClass('' + this.options.linkActiveClass))
                  return void (
                    ...
                    (this._collapseTab(t), this.$element.trigger('collapse.zf.tabs', [t]))
                  );
            ...
            },
            {
              ...
              value: function() {
                this._alignmentsExhausted(this.position)
                  ? ((this.position = a(this.position, h)), (this.alignment = p[this.position][0]))
                  : this._realign();
              },
            },
            {
              ...
              value: function(t, e, i) {
                ...
                if (
                  ...
                  for (
                    ...
                    if (0 === o) return;
                    o < n &&
                      ((n = o), (s = { position: this.position, alignment: this.alignment })),
                      this._reposition(),
                      e.offset(
                        r.a.GetExplicitOffsets(
                          e,
          ...
          u(e, [
            ...
            },
            {
              ...
              value: function(t) {
                ...
                o && (s = this.matchValidation(t, o, t.attr('required'))),
            ...
            },
            {
              ...
              value: function() {
                ...
                return (
                  ...
                  this.$element.trigger((i ? 'formvalid' : 'forminvalid') + '.zf.abide', [
                    this.$element,
                  ]),
                  i
                );
            ...
            },
            {
              ...
              value: function() {
                ...
                this.options.equalizeOn
                  ? ((n = this._checkMQ()),
                    r()(window).on('changed.zf.mediaquery', this._checkMQ.bind(this)))
                  : this._events(),
                  ((void 0 !== n && n === !1) || void 0 === n) &&
                    (s.length ? i.i(u.a)(s, this._reflow.bind(this)) : this._reflow());
              },
            },
            {
              key: '_pauseEvents',
          ...
          h(e, [
            ...
            },
            {
              ...
              value: function() {
                var t = this;
                r()('html, body'),
                  { duration: t.options.animationDuration, easing: t.options.animationEasing };
                ...
                if (!this._inTransition) {
                  ...
                  if (
                    ...
                    (this.$active = this.$links
                      .filter('[href="#' + this.$targets.eq(t).data('magellan-target') + '"]')
              ...
              value: function() {
                ...
                if (
                  ...
                  this.options.contentId
                    ...
                    : (this.nested =
                        0 === this.$element.siblings('[data-off-canvas-content]').length),
                  this.nested === !0 &&
                  ...
                  (this.$triggers = r()(document)
                    .find(
                      '[data-open="' + t + '"], [data-close="' + t + '"], [data-toggle="' + t + '"]'
                    )
            ...
            },
            {
              ...
              value: function(t) {
                'boolean' != typeof t
                  ...
                  : t === !1 && this.$content.removeClass('has-reveal-' + this.position);
              },
            },
            {
              ...
              value: function(t) {
                this._removeContentClasses(t),
                  'boolean' != typeof t
                    ...
                    : t === !0 && this.$content.addClass('has-reveal-' + this.position);
              },
            },
            {
              key: 'reveal',
                ...
                if (!this.$element.hasClass('is-open') && !this.isRevealed) {
                  ...
                  e && (this.$lastTrigger = e),
                    ...
                    this.options.trapFocus === !0 &&
                      (this.$content.attr('tabindex', '-1'), l.a.trapFocus(this.$element)),
              ...
              value: function(t) {
                if (this.$element.hasClass('is-open') && !this.isRevealed) {
                  ...
                  this.$element.removeClass('is-open'),
                    ...
                    this.options.trapFocus === !0 &&
                      (this.$content.removeAttr('tabindex'), l.a.releaseFocus(this.$element)),
                  ...
                  (s = e
                    ...
                    s.length &&
                      ...
                      this.options.useMUI && !this.$element.is(':hidden')
                        ? (u.a.animateIn(
                            s.addClass('is-active').css({ position: 'absolute', top: 0 }),
                            this.options['animInFrom' + r],
                            function() {
                              s.css({ position: 'relative', display: 'block' }).attr(
                                'aria-live',
                                'polite'
                              );
                            }
              ...
              value: function(t, e) {
                (this.$element = r()(t)),
                  ...
                  this.$element.attr('id') ||
                    this.$element.attr('id', i.i(u.a)(6, 'responsiveaccordiontabs')),
                  this._init(),
                  this._events();
              },
            },
                ...
                if ((s.length && (n = 'tabs'), n !== t)) {
                  ...
                  if (
                    ('tabs' === n
                      ...
                      : (s = l.children('[data-tab-content]').removeClass('accordion-content')),
            ...
            },
            {
              ...
              value: function() {
                ...
                r.a.isEmptyObject(this.rules) || this._checkMediaQueries(),
                  this.$element.attr(
                    'data-mutate',
                    this.$element.attr('data-mutate') || i.i(u.a)(6, 'responsive-menu')
                  );
              },
            },
            {
          ...
          g(e, [
              ...
              value: function() {
                d.a._init(),
                  ...
                  this.$overlay
                    ...
                    : (this.$element.detach().appendTo(c()(this.options.appendTo)),
            ...
            },
            {
              ...
              value: function() {
                ...
                this.$element.on({
                  ...
                  this.options.deepLink &&
                    c()(window).on('popstate.zf.reveal:' + this.id, this._handleState.bind(this));
              },
            },
            {
              key: '_handleState',
            ...
            },
            {
              ...
              value: function() {
                function t() {
                  n.isMobile
                    ? (n.originalScrollPos || (n.originalScrollPos = window.pageYOffset),
                ...
                this.options.animationIn
                  ? !(function() {
                      ...
                      e.options.overlay && f.a.animateIn(e.$overlay, 'fade-in'),
                        f.a.animateIn(e.$element, e.options.animationIn, function() {
                          e.$element &&
                            ((e.focusableElements = h.a.findFocusable(e.$element)), i());
                        });
                    })()
            ...
            },
            {
              ...
              value: function() {
                function t() {
                  e.isMobile
                    ? (0 === c()('.reveal:visible').length &&
                      ...
                      e.originalScrollPos &&
                        (c()('body').scrollTop(e.originalScrollPos), (e.originalScrollPos = null)))
                    : 0 === c()('.reveal:visible').length &&
                ...
                this.options.animationOut
                  ? (this.options.overlay && f.a.animateOut(this.$overlay, 'fade-out'),
        ...
        return (
          ...
          v(e, [
            ...
            },
            {
              ...
              value: function() {
                ...
                (this.options.disabled || this.$element.hasClass(this.options.disabledClass)) &&
                  ...
                  this.inputs.length ||
                    ((this.inputs = c()().add(this.$input)), (this.options.binding = !0)),
                  this._setInitAttr(0),
                  this.handles[1] &&
            ...
            },
            {
              ...
              value: function(t) {
                return (
                  (Math.pow(this.options.nonLinearBase, t) - 1) / (this.options.nonLinearBase - 1)
                );
              },
            },
            {
              ...
              value: function(t, e, n) {
                ...
                if (n) (s = this._adjustValue(null, n)), (o = !0);
                  ...
                  var l = this,
                    ...
                    d = u ? 'top' : 'left',
                    p = u ? t.pageY : t.pageX,
                    m = (this.$handle[0].getBoundingClientRect()[h] / 2,
                  ...
                  if (
                    ((s = this._value(w)),
                    i.i(f.c)() && !this.options.vertical && (s = this.options.end - s),
            ...
            },
            {
              ...
              value: function(t, e) {
                ...
                'top' === this.options.stickTo
                  ? ((s -= i), (o -= t + i))
                  : 'bottom' === this.options.stickTo && ((s -= r - (t + n)), (o -= r - n)),
                  (this.topPoint = s),
                  (this.bottomPoint = o),
          ...
          h(e, [
            ...
            },
            {
              ...
              value: function() {
                ...
                r()(
                  '[data-open="' + e + '"], [data-close="' + e + '"], [data-toggle="' + e + '"]'
                ...
                this.options.disableHover ||
                  ...
                  this.options.clickOpen
                    ? this.$element.on('mousedown.zf.tooltip', function(e) {
                        e.stopImmediatePropagation(),
                          t.isClick ||
                            ((t.isClick = !0),
                            (!t.options.disableHover && t.$element.attr('tabindex')) ||
                              t.isActive ||
                              t.show());
                      })
                    : this.$element.on('mousedown.zf.tooltip', function(e) {
                  ...
                  this.$element
                    .on('focus.zf.tooltip', function(i) {
                      return (
                        (e = !0), t.isClick ? (t.options.clickOpen || (e = !1), !1) : void t.show()
                      );
                    })
  ...
  function(t, e, i) {
    ...
    o.a.addToJquery(s.a),
      (o.a.MediaQuery = a.a),
      r.a.init(s.a, o.a),
      o.a.plugin(l.a, 'Slider'),
      o.a.plugin(u.a, 'Drilldown'),
      o.a.plugin(c.a, 'AccordionMenu'),
      o.a.plugin(h.a, 'DropdownMenu'),
      o.a.plugin(d.a, 'Magellan'),
      o.a.plugin(f.a, 'ResponsiveMenu'),
      o.a.plugin(p.a, 'Accordion'),
      o.a.plugin(m.a, 'Dropdown'),
      o.a.plugin(g.a, 'OffCanvas'),
      o.a.plugin(v.a, 'Tabs'),
      o.a.plugin(b.a, 'Reveal'),
      o.a.plugin(y.a, 'ResponsiveAccordionTabs'),
      o.a.plugin(w.a, 'Tooltip'),
      o.a.plugin(_.a, 'Orbit'),
      o.a.plugin($.a, 'Sticky'),
      o.a.plugin(k.a, 'Interchange'),
      o.a.plugin(C.a, 'ResponsiveToggle'),
      o.a.plugin(z.a, 'Toggler'),
      o.a.plugin(O.a, 'Abide'),
      o.a.plugin(T.a, 'Equalizer'),
      o.a.plugin(E.a, 'SmoothScroll');
  },
]);
